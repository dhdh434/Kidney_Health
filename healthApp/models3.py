...
class Comorbidity (models.Model) :
    ...
    targetSerumLevel = models.ForeignKey(TargetSerumLevel,  on_delete=models.CASCADE)
    targetDailyValue = models.ForeignKey(TargetDailyValue,  on_delete=models.CASCADE)
...
class Client (Person) :
    ...
    comorbidity = models.ForeignKey(Comorbidity,  on_delete=models.CASCADE)
...
class FoodDiaryEntry (models.Model) :
    ...
    client = models.ForeignKey(Client, on_delete=models.CASCADE)
    actualDailyValue = models.ForeignKey(ActualDailyValue, on_delete=models.CASCADE)
